...
def get_data():
    global db
    con = conn.connect(host='127.0.0.1', database='security',user='youruesrname', password='123456', charset='utf8', port=3000)
    cursor = con.cursor()
...
def register():
    con = conn.connect(host='127.0.0.1', database='security',user='root', password='123456', charset='utf8', port=3000)
    cursor = con.cursor()
